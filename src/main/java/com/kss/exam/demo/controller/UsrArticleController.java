...
import com.kss.exam.demo.service.ReplyService;
...
public class UsrArticleController {
	...
	@ResponseBody
	public String doAdd(@RequestParam(defaultValue = "1") int boardId, String title, String body, String replaceUri) {
	...
	public String showList(Model model, 
		...
		List<Article> articles = articleService.getForPrintArticles(rq.getLoginedMemberId(), boardId, itemsCountInAPage, page, searchKeywordTypeCode, searchKeyword);
